...
//  ReadMe
//
//  Created by Joan Paredes on 16/11/20.
//
...
class LibraryViewController: UITableViewController {
    ...
    @IBAction func sortByRearMe(_ sender: UIBarButtonItem) {
...
class LibraryDataSource : UITableViewDiffableDataSource<Section, Book> {
    ...
    func update(sortStyle: SortStyle, animatingDifferences: Bool = true){
        ...
        let bookByReadMe : [Bool: [Book]] = Dictionary(grouping: Library.books, by: \.readMe)
        for (readMe, books) in bookByReadMe{
